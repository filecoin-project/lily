...
func (dp *MarketDealProposal) Persist(ctx context.Context, s model.StorageBatch, version int) error {
...
func (dps MarketDealProposals) Persist(ctx context.Context, s model.StorageBatch, version int) error {
