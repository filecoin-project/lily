...
func (m *MinerCurrentDeadlineInfo) Persist(ctx context.Context, s model.StorageBatch, version int) error {
...
func (ml MinerCurrentDeadlineInfoList) Persist(ctx context.Context, s model.StorageBatch, version int) error {
