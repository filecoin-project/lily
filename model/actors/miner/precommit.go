...
func (mpi *MinerPreCommitInfo) Persist(ctx context.Context, s model.StorageBatch, version int) error {
...
func (ml MinerPreCommitInfoList) Persist(ctx context.Context, s model.StorageBatch, version int) error {
