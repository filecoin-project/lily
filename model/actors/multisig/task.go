...
func (mtr *MultisigTaskResult) Persist(ctx context.Context, s model.StorageBatch, version int) error {
...
func (ml MultisigTaskResultList) Persist(ctx context.Context, s model.StorageBatch, version int) error {
	for _, res := range ml {
