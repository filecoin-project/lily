...
func (m *MultisigTransaction) Persist(ctx context.Context, s model.StorageBatch, version int) error {
...
func (ml MultisigTransactionList) Persist(ctx context.Context, s model.StorageBatch, version int) error {
	ctx, _ = tag.New(ctx, tag.Upsert(metrics.Table, "multisig_transactions"))
	stop := metrics.Timer(ctx, metrics.PersistDuration)
	defer stop()
