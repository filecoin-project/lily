...
func (bp *BlockParent) Persist(ctx context.Context, s model.StorageBatch, version int) error {
...
func (bps BlockParents) Persist(ctx context.Context, s model.StorageBatch, version int) error {
	if len(bps) == 0 {
		return nil
	}
