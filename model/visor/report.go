...
func (p *ProcessingReport) Persist(ctx context.Context, s model.StorageBatch, version int) error {
...
func (pl ProcessingReportList) Persist(ctx context.Context, s model.StorageBatch, version int) error {
	if len(pl) == 0 {
		return nil
	}
