...
| :-----------------: | :----------------------------------------------------------: | :----------------------------------------------------------: | :----------------------------: |
|       blocks        | [block_headers](./models.md#block_headers), [block_parents](./models.md#block_parents), [drand_block_entries](./models.md#drand_block_entries) |      Captures data about blocks and their relationships      |              1 ms              |
