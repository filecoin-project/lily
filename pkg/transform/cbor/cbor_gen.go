...
func (t *MinerStateChange) MarshalCBOR(w io.Writer) error {
	if t == nil {
...
func (t *MinerStateChange) UnmarshalCBOR(r io.Reader) (err error) {
	*t = MinerStateChange{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("MinerStateChange: map struct too large (%d)", extra)
	}
