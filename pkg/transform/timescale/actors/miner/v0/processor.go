...
type Extractor interface {
	Extract(ctx context.Context, current, parent *types.TipSet, addr address.Address, change *v0.StateDiffResult) (model.Persistable, error)
}
...
func (se *StateExtract) Process(ctx context.Context, current, executed *types.TipSet, addr address.Address, changes *v0.StateDiffResult) (model.PersistableList, error) {
