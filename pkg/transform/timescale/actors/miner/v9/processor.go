...
type Extractor interface {
	Extract(ctx context.Context, current, parent *types.TipSet, addr address.Address, change *v9.StateDiffResult) (model.Persistable, error)
}
...
func (se *StateExtract) Process(ctx context.Context, current, executed *types.TipSet, addr address.Address, changes *v9.StateDiffResult) (model.PersistableList, error) {
