...
func (s *state10) SectorsArray() (adt.Array, error) {
...
func (s *state10) PrecommitsMap() (adt.Map, error) {
	return adt10.AsMap(s.store, s.PreCommittedSectors, builtin10.DefaultHamtBitwidth)
}

func (s *state10) PrecommitsMapBitWidth() int {

	return builtin10.DefaultHamtBitwidth

}

func (s *state10) PrecommitsMapHashFunction() func(input []byte) []byte {
...
func (s *state10) DecodeSectorPreCommitOnChainInfoToV8(val *cbg.Deferred) (minertypesv8.SectorPreCommitOnChainInfo, error) {

	return minertypesv8.SectorPreCommitOnChainInfo{}, fmt.Errorf("unsupported in actors v9")

}

func (s *state10) ForEachPrecommittedSectorV8(cb func(minertypesv8.SectorPreCommitOnChainInfo) error) error {
...
func (d *deadline10) FaultyPowerQA() (big.Int, error) {
	return big.Zero(), nil
}

func (d *deadline10) LivePowerQA() (big.Int, error) {
	return big.Zero(), nil
}
...
func (s *state10) SectorsAmtBitwidth() int {
	return miner10.SectorsAmtBitwidth
}
