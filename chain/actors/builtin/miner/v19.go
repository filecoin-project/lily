...
func (s *state19) SectorsArray() (adt.Array, error) {
...
func (s *state19) PrecommitsMap() (adt.Map, error) {
	return adt19.AsMap(s.store, s.PreCommittedSectors, builtin19.DefaultHamtBitwidth)
}

func (s *state19) PrecommitsMapBitWidth() int {

	return builtin19.DefaultHamtBitwidth

}

func (s *state19) PrecommitsMapHashFunction() func(input []byte) []byte {
...
func (s *state19) DecodeSectorPreCommitOnChainInfoToV8(val *cbg.Deferred) (minertypesv8.SectorPreCommitOnChainInfo, error) {

	return minertypesv8.SectorPreCommitOnChainInfo{}, fmt.Errorf("unsupported in actors v9")

}

func (s *state19) ForEachPrecommittedSectorV8(cb func(minertypesv8.SectorPreCommitOnChainInfo) error) error {
...
func (d *deadline19) FaultyPowerQA() (big.Int, error) {
...
func (d *deadline19) LivePowerQA() (big.Int, error) {
...
func (s *state19) SectorsAmtBitwidth() int {
	return miner19.SectorsAmtBitwidth
}
