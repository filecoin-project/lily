...
func (_m *State) DecodeSectorOnChainInfo(_a0 *typegen.Deferred) (v8miner.SectorOnChainInfo, error) {
	ret := _m.Called(_a0)

	var r0 v8miner.SectorOnChainInfo
	if rf, ok := ret.Get(0).(func(*typegen.Deferred) v8miner.SectorOnChainInfo); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Get(0).(v8miner.SectorOnChainInfo)
	}
...
func (_m *State) DecodeSectorPreCommitOnChainInfo(_a0 *typegen.Deferred) (v8miner.SectorPreCommitOnChainInfo, error) {
	ret := _m.Called(_a0)
...
func (_m *State) ForEachPrecommittedSector(_a0 func(v8miner.SectorPreCommitOnChainInfo) error) error {
	ret := _m.Called(_a0)
...
func (_m *State) GetPrecommittedSector(_a0 abi.SectorNumber) (*v8miner.SectorPreCommitOnChainInfo, error) {
	ret := _m.Called(_a0)

	var r0 *v8miner.SectorPreCommitOnChainInfo
	if rf, ok := ret.Get(0).(func(abi.SectorNumber) *v8miner.SectorPreCommitOnChainInfo); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v8miner.SectorPreCommitOnChainInfo)
...
func (_m *State) GetSector(_a0 abi.SectorNumber) (*v8miner.SectorOnChainInfo, error) {
	ret := _m.Called(_a0)

	var r0 *v8miner.SectorOnChainInfo
	if rf, ok := ret.Get(0).(func(abi.SectorNumber) *v8miner.SectorOnChainInfo); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v8miner.SectorOnChainInfo)
...
func (_m *State) Info() (v8miner.MinerInfo, error) {
	ret := _m.Called()

	var r0 v8miner.MinerInfo
	if rf, ok := ret.Get(0).(func() v8miner.MinerInfo); ok {
		r0 = rf()
	} else {
		r0 = ret.Get(0).(v8miner.MinerInfo)
	}
...
func (_m *State) LoadSectors(sectorNos *bitfield.BitField) ([]*v8miner.SectorOnChainInfo, error) {
	ret := _m.Called(sectorNos)

	var r0 []*v8miner.SectorOnChainInfo
	if rf, ok := ret.Get(0).(func(*bitfield.BitField) []*v8miner.SectorOnChainInfo); ok {
		r0 = rf(sectorNos)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*v8miner.SectorOnChainInfo)
