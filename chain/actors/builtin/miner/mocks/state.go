...
import (
	...
	adt "github.com/filecoin-project/lily/chain/actors/adt"
...
func (_m *State) DecodeSectorOnChainInfo(_a0 *typegen.Deferred) (miner.SectorOnChainInfo, error) {
	ret := _m.Called(_a0)

	var r0 miner.SectorOnChainInfo
	if rf, ok := ret.Get(0).(func(*typegen.Deferred) miner.SectorOnChainInfo); ok {
		r0 = rf(_a0)
	} else {
...
func (_m *State) DecodeSectorPreCommitOnChainInfo(_a0 *typegen.Deferred) (miner.SectorPreCommitOnChainInfo, error) {
	ret := _m.Called(_a0)

	var r0 miner.SectorPreCommitOnChainInfo
	if rf, ok := ret.Get(0).(func(*typegen.Deferred) miner.SectorPreCommitOnChainInfo); ok {
		r0 = rf(_a0)
	} else {
...
func (_m *State) ForEachPrecommittedSector(_a0 func(miner.SectorPreCommitOnChainInfo) error) error {
	ret := _m.Called(_a0)

	var r0 error
	if rf, ok := ret.Get(0).(func(func(miner.SectorPreCommitOnChainInfo) error) error); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *State) GetPrecommittedSector(_a0 abi.SectorNumber) (*miner.SectorPreCommitOnChainInfo, error) {
	ret := _m.Called(_a0)

	var r0 *miner.SectorPreCommitOnChainInfo
	if rf, ok := ret.Get(0).(func(abi.SectorNumber) *miner.SectorPreCommitOnChainInfo); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*miner.SectorPreCommitOnChainInfo)
...
func (_m *State) GetSector(_a0 abi.SectorNumber) (*miner.SectorOnChainInfo, error) {
	ret := _m.Called(_a0)

	var r0 *miner.SectorOnChainInfo
	if rf, ok := ret.Get(0).(func(abi.SectorNumber) *miner.SectorOnChainInfo); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*miner.SectorOnChainInfo)
...
func (_m *State) Info() (miner.MinerInfo, error) {
	ret := _m.Called()

	var r0 miner.MinerInfo
	if rf, ok := ret.Get(0).(func() miner.MinerInfo); ok {
		r0 = rf()
	} else {
...
func (_m *State) LoadSectors(sectorNos *bitfield.BitField) ([]*miner.SectorOnChainInfo, error) {
	ret := _m.Called(sectorNos)

	var r0 []*miner.SectorOnChainInfo
	if rf, ok := ret.Get(0).(func(*bitfield.BitField) []*miner.SectorOnChainInfo); ok {
		r0 = rf(sectorNos)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*miner.SectorOnChainInfo)
...
// PreCommitMap provides a mock function with given fields:
func (_m *State) PreCommitMap() (adt.Map, error) {
	ret := _m.Called()
...
// SectorArray provides a mock function with given fields:
func (_m *State) SectorArray() (adt.Array, error) {
	ret := _m.Called()
