...
func (_m *State) DecodeSectorOnChainInfo(_a0 *typegen.Deferred) (v14miner.SectorOnChainInfo, error) {
	ret := _m.Called(_a0)

	var r0 v14miner.SectorOnChainInfo
	if rf, ok := ret.Get(0).(func(*typegen.Deferred) v14miner.SectorOnChainInfo); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Get(0).(v14miner.SectorOnChainInfo)
	}
...
func (_m *State) GetSector(_a0 abi.SectorNumber) (*v14miner.SectorOnChainInfo, error) {
	ret := _m.Called(_a0)

	var r0 *v14miner.SectorOnChainInfo
	if rf, ok := ret.Get(0).(func(abi.SectorNumber) *v14miner.SectorOnChainInfo); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v14miner.SectorOnChainInfo)
...
func (_m *State) LoadSectors(sectorNos *bitfield.BitField) ([]*v14miner.SectorOnChainInfo, error) {
	ret := _m.Called(sectorNos)

	var r0 []*v14miner.SectorOnChainInfo
	if rf, ok := ret.Get(0).(func(*bitfield.BitField) []*v14miner.SectorOnChainInfo); ok {
		r0 = rf(sectorNos)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*v14miner.SectorOnChainInfo)
