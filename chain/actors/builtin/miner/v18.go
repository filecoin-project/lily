...
func (s *state18) SectorsArray() (adt.Array, error) {
...
func (s *state18) PrecommitsMap() (adt.Map, error) {
	return adt18.AsMap(s.store, s.PreCommittedSectors, builtin18.DefaultHamtBitwidth)
}

func (s *state18) PrecommitsMapBitWidth() int {

	return builtin18.DefaultHamtBitwidth

}

func (s *state18) PrecommitsMapHashFunction() func(input []byte) []byte {
...
func (s *state18) DecodeSectorPreCommitOnChainInfoToV8(val *cbg.Deferred) (minertypesv8.SectorPreCommitOnChainInfo, error) {

	return minertypesv8.SectorPreCommitOnChainInfo{}, fmt.Errorf("unsupported in actors v9")

}

func (s *state18) ForEachPrecommittedSectorV8(cb func(minertypesv8.SectorPreCommitOnChainInfo) error) error {
...
func (d *deadline18) FaultyPowerQA() (big.Int, error) {
	if d.Deadline.FaultyPower.QA.Int != nil {
		return d.Deadline.FaultyPower.QA, nil
	}
	return big.Zero(), nil
}

func (d *deadline18) LivePowerQA() (big.Int, error) {
	if d.Deadline.LivePower.QA.Int != nil {
		return d.Deadline.LivePower.QA, nil
	}
	return big.Zero(), nil
}
...
func (s *state18) SectorsAmtBitwidth() int {
	return miner18.SectorsAmtBitwidth
}
