...
func (s *state13) SectorsArray() (adt.Array, error) {
...
func (s *state13) PrecommitsMap() (adt.Map, error) {
	return adt13.AsMap(s.store, s.PreCommittedSectors, builtin13.DefaultHamtBitwidth)
}

func (s *state13) PrecommitsMapBitWidth() int {

	return builtin13.DefaultHamtBitwidth

}

func (s *state13) PrecommitsMapHashFunction() func(input []byte) []byte {
...
func (s *state13) DecodeSectorPreCommitOnChainInfoToV8(val *cbg.Deferred) (minertypesv8.SectorPreCommitOnChainInfo, error) {

	return minertypesv8.SectorPreCommitOnChainInfo{}, fmt.Errorf("unsupported in actors v9")

}

func (s *state13) ForEachPrecommittedSectorV8(cb func(minertypesv8.SectorPreCommitOnChainInfo) error) error {
...
func (d *deadline13) FaultyPowerQA() (big.Int, error) {
	return big.Zero(), nil
}

func (d *deadline13) LivePowerQA() (big.Int, error) {
	return big.Zero(), nil
}
...
func (s *state13) SectorsAmtBitwidth() int {
	return miner13.SectorsAmtBitwidth
}
