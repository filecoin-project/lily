...
func (s *state12) SectorsArray() (adt.Array, error) {
...
func (s *state12) PrecommitsMap() (adt.Map, error) {
	return adt12.AsMap(s.store, s.PreCommittedSectors, builtin12.DefaultHamtBitwidth)
}

func (s *state12) PrecommitsMapBitWidth() int {

	return builtin12.DefaultHamtBitwidth

}

func (s *state12) PrecommitsMapHashFunction() func(input []byte) []byte {
...
func (s *state12) DecodeSectorPreCommitOnChainInfoToV8(val *cbg.Deferred) (minertypesv8.SectorPreCommitOnChainInfo, error) {

	return minertypesv8.SectorPreCommitOnChainInfo{}, fmt.Errorf("unsupported in actors v9")

}

func (s *state12) ForEachPrecommittedSectorV8(cb func(minertypesv8.SectorPreCommitOnChainInfo) error) error {
...
func (d *deadline12) FaultyPowerQA() (big.Int, error) {
	return big.Zero(), nil
}

func (d *deadline12) LivePowerQA() (big.Int, error) {
	return big.Zero(), nil
}
...
func (s *state12) SectorsAmtBitwidth() int {
	return miner12.SectorsAmtBitwidth
}
