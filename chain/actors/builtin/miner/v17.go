...
func (s *state17) SectorsArray() (adt.Array, error) {
...
func (s *state17) PrecommitsMap() (adt.Map, error) {
	return adt17.AsMap(s.store, s.PreCommittedSectors, builtin17.DefaultHamtBitwidth)
}

func (s *state17) PrecommitsMapBitWidth() int {

	return builtin17.DefaultHamtBitwidth

}

func (s *state17) PrecommitsMapHashFunction() func(input []byte) []byte {
...
func (s *state17) DecodeSectorPreCommitOnChainInfoToV8(val *cbg.Deferred) (minertypesv8.SectorPreCommitOnChainInfo, error) {

	return minertypesv8.SectorPreCommitOnChainInfo{}, fmt.Errorf("unsupported in actors v9")

}

func (s *state17) ForEachPrecommittedSectorV8(cb func(minertypesv8.SectorPreCommitOnChainInfo) error) error {
...
func (d *deadline17) FaultyPowerQA() (big.Int, error) {
...
func (d *deadline17) LivePowerQA() (big.Int, error) {
...
func (s *state17) SectorsAmtBitwidth() int {
	return miner17.SectorsAmtBitwidth
}
