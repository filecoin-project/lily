...
func (s *state11) SectorsArray() (adt.Array, error) {
...
func (s *state11) PrecommitsMap() (adt.Map, error) {
	return adt11.AsMap(s.store, s.PreCommittedSectors, builtin11.DefaultHamtBitwidth)
}

func (s *state11) PrecommitsMapBitWidth() int {

	return builtin11.DefaultHamtBitwidth

}

func (s *state11) PrecommitsMapHashFunction() func(input []byte) []byte {
...
func (s *state11) DecodeSectorPreCommitOnChainInfoToV8(val *cbg.Deferred) (minertypesv8.SectorPreCommitOnChainInfo, error) {

	return minertypesv8.SectorPreCommitOnChainInfo{}, fmt.Errorf("unsupported in actors v9")

}

func (s *state11) ForEachPrecommittedSectorV8(cb func(minertypesv8.SectorPreCommitOnChainInfo) error) error {
...
func (d *deadline11) FaultyPowerQA() (big.Int, error) {
	return big.Zero(), nil
}

func (d *deadline11) LivePowerQA() (big.Int, error) {
	return big.Zero(), nil
}
...
func (s *state11) SectorsAmtBitwidth() int {
	return miner11.SectorsAmtBitwidth
}
