...
func (s *state14) SectorsArray() (adt.Array, error) {
...
func (s *state14) PrecommitsMap() (adt.Map, error) {
	return adt14.AsMap(s.store, s.PreCommittedSectors, builtin14.DefaultHamtBitwidth)
}

func (s *state14) PrecommitsMapBitWidth() int {

	return builtin14.DefaultHamtBitwidth

}

func (s *state14) PrecommitsMapHashFunction() func(input []byte) []byte {
...
func (s *state14) DecodeSectorPreCommitOnChainInfoToV8(val *cbg.Deferred) (minertypesv8.SectorPreCommitOnChainInfo, error) {

	return minertypesv8.SectorPreCommitOnChainInfo{}, fmt.Errorf("unsupported in actors v9")

}

func (s *state14) ForEachPrecommittedSectorV8(cb func(minertypesv8.SectorPreCommitOnChainInfo) error) error {
...
func (d *deadline14) FaultyPowerQA() (big.Int, error) {
	return big.Zero(), nil
}

func (d *deadline14) LivePowerQA() (big.Int, error) {
	return big.Zero(), nil
}
...
func (s *state14) SectorsAmtBitwidth() int {
	return miner14.SectorsAmtBitwidth
}
