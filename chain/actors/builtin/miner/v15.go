...
func (s *state15) SectorsArray() (adt.Array, error) {
...
func (s *state15) PrecommitsMap() (adt.Map, error) {
	return adt15.AsMap(s.store, s.PreCommittedSectors, builtin15.DefaultHamtBitwidth)
}

func (s *state15) PrecommitsMapBitWidth() int {

	return builtin15.DefaultHamtBitwidth

}

func (s *state15) PrecommitsMapHashFunction() func(input []byte) []byte {
...
func (s *state15) DecodeSectorPreCommitOnChainInfoToV8(val *cbg.Deferred) (minertypesv8.SectorPreCommitOnChainInfo, error) {

	return minertypesv8.SectorPreCommitOnChainInfo{}, fmt.Errorf("unsupported in actors v9")

}

func (s *state15) ForEachPrecommittedSectorV8(cb func(minertypesv8.SectorPreCommitOnChainInfo) error) error {
...
func (s *state15) SectorsAmtBitwidth() int {
	return miner15.SectorsAmtBitwidth
}
