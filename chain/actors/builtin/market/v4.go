...
func (s *state4) ProviderSectorsHamtBitwidth() int {
	return 0
}
...
func (s *state4) GetProviderSectorsByDealID(dealIDMap map[abi.DealID]bool, prevState State, minerChanges map[address.Address]bool) (map[abi.DealID]abi.SectorID, error) {

	return nil, nil

}

func (s *state4) ProviderSectorMapHashFunction() func(input []byte) []byte {
...
func (s *state4) ProviderSectorsMap() (adt.Map, error) {
	return nil, nil
}

func (s *state4) ProviderSectorsCid() cid.Cid {
	return cid.Cid{}
}
