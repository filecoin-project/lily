...
func (s *state9) ProviderSectorsHamtBitwidth() int {
	return 0
}
...
func (s *state9) GetProviderSectors() (map[abi.SectorID][]abi.DealID, error) {

	return nil, nil

}

func (s *state9) GetProviderSectorsByDealID(dealIDMap map[abi.DealID]bool, prevState State, minerChanges map[address.Address]bool) (map[abi.DealID]abi.SectorID, error) {

	return nil, nil

}

func (s *state9) ProviderSectorMapHashFunction() func(input []byte) []byte {
...
func (s *state9) ProviderSectorsMap() (adt.Map, error) {
	return nil, nil
}

func (s *state9) ProviderSectorsCid() cid.Cid {
	return cid.Cid{}
}
