...
func (s *state5) ProviderSectorsHamtBitwidth() int {
	return 0
}
...
func (s *state5) GetProviderSectors() (map[abi.SectorID][]abi.DealID, error) {

	return nil, nil

}

func (s *state5) GetProviderSectorsByDealID(dealIDMap map[abi.DealID]bool, prevState State, minerChanges map[address.Address]bool) (map[abi.DealID]abi.SectorID, error) {

	return nil, nil

}

func (s *state5) ProviderSectorMapHashFunction() func(input []byte) []byte {
...
func (s *state5) ProviderSectorsMap() (adt.Map, error) {
	return nil, nil
}

func (s *state5) ProviderSectorsCid() cid.Cid {
	return cid.Cid{}
}
