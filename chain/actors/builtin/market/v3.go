...
func (s *state3) ProviderSectorsHamtBitwidth() int {
	return 0
}
...
func (s *state3) GetProviderSectorsByDealID(dealIDMap map[abi.DealID]bool, prevState State, minerChanges map[address.Address]bool) (map[abi.DealID]abi.SectorID, error) {

	return nil, nil

}

func (s *state3) ProviderSectorMapHashFunction() func(input []byte) []byte {
...
func (s *state3) ProviderSectorsMap() (adt.Map, error) {
	return nil, nil
}

func (s *state3) ProviderSectorsCid() cid.Cid {
	return cid.Cid{}
}
