...
func (s *state18) PendingTransactionsMap() (adt.Map, error) {
	return adt18.AsMap(s.store, s.PendingTxns, builtin18.DefaultHamtBitwidth)
}

func (s *state18) PendingTransactionsMapBitWidth() int {

	return builtin18.DefaultHamtBitwidth

}

func (s *state18) PendingTransactionsMapHashFunction() func(input []byte) []byte {
