...
func (s *state15) PendingTransactionsMap() (adt.Map, error) {
	return adt15.AsMap(s.store, s.PendingTxns, builtin15.DefaultHamtBitwidth)
}

func (s *state15) PendingTransactionsMapBitWidth() int {

	return builtin15.DefaultHamtBitwidth

}

func (s *state15) PendingTransactionsMapHashFunction() func(input []byte) []byte {
