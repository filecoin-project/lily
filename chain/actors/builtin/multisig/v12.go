...
func (s *state12) PendingTransactionsMap() (adt.Map, error) {
	return adt12.AsMap(s.store, s.PendingTxns, builtin12.DefaultHamtBitwidth)
}

func (s *state12) PendingTransactionsMapBitWidth() int {

	return builtin12.DefaultHamtBitwidth

}

func (s *state12) PendingTransactionsMapHashFunction() func(input []byte) []byte {
