...
func (s *state14) PendingTransactionsMap() (adt.Map, error) {
	return adt14.AsMap(s.store, s.PendingTxns, builtin14.DefaultHamtBitwidth)
}

func (s *state14) PendingTransactionsMapBitWidth() int {

	return builtin14.DefaultHamtBitwidth

}

func (s *state14) PendingTransactionsMapHashFunction() func(input []byte) []byte {
