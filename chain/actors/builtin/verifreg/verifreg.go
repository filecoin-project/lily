...
type State interface {
	...
	AllocationsMap() (adt.Map, error)
	AllocationMapForClient(clientIdAddr address.Address) (adt.Map, error)
	AllocationsMapBitWidth() int
	AllocationsMapHashFunction() func(input []byte) []byte
