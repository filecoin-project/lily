...
func init() {
	extractors.Register(&MinerSectorDeal{}, ExtractMinerSectorDeals)
}

func ExtractMinerSectorDeals(ctx context.Context, ec *extractors.MinerStateExtractionContext) (model.Persistable, error) {
