...
func init() {
	extractors.Register(&MinerFeeDebt{}, ExtractMinerFeeDebt)
}

func ExtractMinerFeeDebt(ctx context.Context, ec *extractors.MinerStateExtractionContext) (model.Persistable, error) {
