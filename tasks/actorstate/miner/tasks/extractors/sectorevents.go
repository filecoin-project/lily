...
func init() {
	tasks.Register(&MinerSectorEvent{}, ExtractMinerSectorEvents)
}

func ExtractMinerSectorEvents(ctx context.Context, ec *tasks.MinerStateExtractionContext) (model.Persistable, error) {
...
func extractMinerSectorEvents(ctx context.Context, ec *tasks.MinerStateExtractionContext, sc *miner.SectorChanges, pc *miner.PreCommitChanges) (MinerSectorEventList, error) {
...
func extractMinerPartitionsDiff(ctx context.Context, ec *tasks.MinerStateExtractionContext) (*PartitionStatus, error) {
