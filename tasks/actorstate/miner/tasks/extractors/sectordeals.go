...
func init() {
	tasks.Register(&MinerSectorDeal{}, ExtractMinerSectorDeals)
}

func ExtractMinerSectorDeals(ctx context.Context, ec *tasks.MinerStateExtractionContext) (model.Persistable, error) {
