...
func init() {
	tasks.Register(&MinerSectorPost{}, ExtractMinerPoSts)
}

func ExtractMinerPoSts(ctx context.Context, ec *tasks.MinerStateExtractionContext) (model.Persistable, error) {
