...
func init() {
	extract.Register(&MinerFeeDebt{}, ExtractMinerFeeDebt)
}

func ExtractMinerFeeDebt(ctx context.Context, ec *extract.MinerStateExtractionContext) (model.Persistable, error) {
