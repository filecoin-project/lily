...
func (t *Task) ProcessTipSets(ctx context.Context, child, parent *types.TipSet) (model.Persistable, *visormodel.ProcessingReport, error) {
	...
	rp := &visormodel.ProcessingReport{
		Height:    int64(child.Height()),
		StateRoot: child.ParentState().String(),
	}
	return pl, rp, nil
}
